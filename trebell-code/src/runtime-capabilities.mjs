...
const RUNTIME_CAPABILITY_OVERRIDES=Object.freeze({
  native:Object.freeze({
    compaction:true,dynamicTools:true,usageReporting:true,contextReporting:true,detachedTasks:true,multiModelFanout:true,nativeHistoryPagination:true,steering:true,delegation:true,
  }),
  codex:Object.freeze({
