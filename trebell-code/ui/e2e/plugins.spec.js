...
test("Codex plugin discovery exposes native search, details, skill contents and reconcile",async({page})=>{
  ...
  upstreamWss.on("connection",ws=>{
    ...
    ws.on("message",data=>{
      ...
      else if(message.method==="permissionProfile/list"||message.method==="mcpServerStatus/list"||message.method==="hooks/list"||message.method==="experimentalFeature/list"||message.method==="plugin/share/list")result={data:[]};
