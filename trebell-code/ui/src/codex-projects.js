...
export function matchingCodexProject(projects=[],{trebellProjectId=null,cwd=""}={}){
...
export async function ensureCodexProject(client,{trebellProject,cwd,maxPages=20}={}){
  ...
  const existing=matchingCodexProject(projects,{trebellProjectId:trebellProject?.id,cwd});
