...
export default function PreviewPage({onAttachText,onAttachImage}){
  ...
  return <div className="preview-page">
    ...
    <p className="preview-note">The iframe is a visual preview. The isolated Agent Browser gives Codex DOM-aware browser control; desktop Computer Use is available separately in Full access mode.</p>
  </div>;
}
